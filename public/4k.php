...
<?php
  ...
  if(isset($_GET['date1'])) {
    ...
    $strQuery = "SELECT * FROM udp_dl_4k WHERE timestamp >= '" . $_GET['date1'] . "'
    AND timestamp <= '" . $_GET['date2'] . "';";

  } else {

    $strQuery = "SELECT * FROM udp_dl_4k;";
...
<?php require_once("../includes/layouts/navigation.php") ?>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card-2 w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-user-circle fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>User <?php echo $user_id; ?>: 4k Video Streaming</h2>
